...
function showStep(n) {
  ...
  btnNext.textContent = currentStep === 5 ? 'Fermer' : 'Suivant';
}
if (stepRoot) {
  showStep(1);
...
f.skills = "Recueil des besoins, Communication avec les parties prenantes, Tests UAT / BAT, Validation et réconciliation des données, Amélioration des processus, Résolution de problèmes techniques, Coordination transverse, Compétences analytiques, Rédaction de documentation, Analyse des systèmes";
f.tools = "JIRA, SQL, Intégration et monitoring d’API, Confluence, Microsoft Excel, Environnements de test UAT, Outils de documentation, Outils de gestion des workflows, Plateformes collaboratives";
f.profile = f.profile || {};
f.profile.languages = "Français : C2 (natif)\nAnglais : C1 (courant)\nNéerlandais : B1 (intermédiaire)";
  ...
  const profileHtml = f.profile ? (function(){
    ...
    const summaryBlock = f.about ? `
      <div style="margin-top:8px;max-width:720px;margin-left:auto;margin-right:auto;">
        <div style="font-weight:700;font-size:12px;margin-bottom:6px;text-align:center;">RÉSUMÉ</div>
    ...
    return `
      <div class="section" style="text-align:center;">
        ...
        <div style="font-weight:700;font-size:12px;margin:12px 0 6px;text-align:center;">EXPÉRIENCE</div>
        ...
        ${ (f.profile.edu1 || f.profile.edu2) ? (function(){
          ...
          return `
            <div style="margin-top:10px;max-width:720px;margin-left:auto;margin-right:auto;text-align:left;">
              <div style="font-weight:700;font-size:12px;margin-bottom:6px;text-align:center;">FORMATION ET CERTIFICATIONS</div>
        ...
        <div style="margin-top:10px;max-width:720px;margin-left:auto;margin-right:auto;text-align:center;">
          <div style="font-weight:700;font-size:12px;margin-bottom:6px;">COMPÉTENCES ET LANGUES</div>
          <div style="max-width:720px;margin-left:auto;margin-right:auto;text-align:left;font-size:11px;color:#111;">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px;margin-bottom:8px;">
              <div style="font-weight:600;min-width:110px;">Compétences</div>
              <div style="flex:1;text-align:left;">${f.skills ? escapeHtml(f.skills) : ''}</div>
            </div>
            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px;margin-bottom:8px;">
              <div style="font-weight:600;min-width:110px;">Outils</div>
              <div style="flex:1;text-align:left;">${f.tools ? escapeHtml(f.tools) : ''}</div>
            </div>
            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px;">
              <div style="font-weight:600;min-width:110px;">Langues</div>
